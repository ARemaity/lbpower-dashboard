			...
			<div class="container">
				<div class="row">
					<div class="col-lg-6 text-center text-lg-left parallax-fade-top align-self-center z-bigger">
						<h2>The Power's in Your Hand</h2>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="title-wrap text-center">
							<h5 class="color-light">Live Graph Electricity Consumption</h5>
						</div>
					</div>
	...
	<div class="section padding-top-bottom-big" id="app">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<div class="title-wrap text-center">
						<div class="back-title">Power</div>
						<h3>Control your Home<br>Power</h3>
						<p>All-in-one app to manage and control live power</p>
					</div>
				</div>
			</div>	
		</div>
		<div class="container">
			<div class="row">
				<div class="col-md-6 align-self-center" data-scroll-reveal="enter bottom move 50px over 0.6s after 0.3s">
					<h4>It begins with Graph</h4>
					<p class="lead">allow you to stay tuned with all thing happen with you home's power</p>
					<ul class="app-list mb-5 mt-4">
						<li>Smart by design</li>
						<li>easy control</li>
						<li>manage your paymet</li>
						<li>Detailed transaction info</li>
						<li>set limit plan for your power</li>
					</ul>
...
<!-- 
					...
					<div id="accordion" class="accordion-style">
						<div class="card">
							...
							<div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
								<div class="card-body">
									<h6>What is kw/h?</h6>
									<p>The kilowatt hour is a unit of energy equal to 3.6 megajoules. If energy is transmitted or used at a constant rate over a period of time, the total energy in kilowatt hours is equal to the power in kilowatts multiplied by the time in hours</p>
								</div>
							</div>
						</div>
						...
						<div class="card">
							<div class="card-header" id="headingTwo">
								<a class="collapsed background-white" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
									how to calculate the kw of an electric device?
								</a>
							</div>
							<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
								<div class="card-body">
									<h6>how to calculate the kw of an electric device?</h6>
									<p>
										Multiply wattage by hours used each day. Watts measure power, or energy used over time. Multiplying by a unit of time gives you an answer in terms of energy, which is what matters for your electrical bill.</p>
								</div>
							</div>
						</div>
						...
						<div class="card">
							<div class="card-header" id="headingThree">
								<a class="collapsed background-white" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
									how ensure to take all benefit of this electrcity system?
								</a>
							</div>
							<div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
								<div class="card-body">
									<h6>how ensure to take all benefit of this electrcity system?</h6>
									<p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Maxime ut aut voluptatum possimus, vero minima libero modi quam neque commodi eum voluptas totam rerum nesciunt iure velit repellat! Non, tenetur?</p>
								</div>
							</div>
						</div>
						...
						<div class="card">
							<div class="card-header" id="headingFive">
								<a class="collapsed background-white" data-toggle="collapse" data-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
									how voltage power can effect the amp sensor?
								</a>
							</div>
							<div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#accordion-snd">
								<div class="card-body">
									<h6>how voltage power can effect the amp sensor?</h6>
									<p>Ohm's law defines the relationship between the voltage, current, and resistance in an electric circuit: i = v/r. The current is directly proportional to the voltage and inversely proportional to the resistance.</p>
								</div>
							</div>
						</div>
					</div>				
	...
	<div class="section padding-top-bottom-big" id="contact">
		...
		<div class="container">
			...
			<form id="contact-form" class="mt-5" method="post" action="https://ivang-design.com/coeus/contact.php" role="form" data-scroll-reveal="enter bottom move 50px over 0.6s after 0.3s">
				<div class="row justify-content-center">
					<div class="col-md-8">
