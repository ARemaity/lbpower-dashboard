...
$insert = mysqli_query($connect, " INSERT INTO person (role,fname,lname,city,street,phone)  VALUES ('" . 0 . "','" . $_POST['fname'] . "','" . $_POST['lname'] ."','" . $_POST['city'] ."','". $_POST['street'] ."','". $_POST['phone']."')");  
