...
(1, 0, 'Natsu', 'Dragneel', 'Hargeon', 'Lacrema', 12345667, 'ndrag@gmail.com'),
...
(14, 1, 'hargero', 'master', 'istanbul', 'asdfg', 381213531, 'hargero@gmail.com');
...
--
ALTER TABLE `device`
  MODIFY `id_device` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
